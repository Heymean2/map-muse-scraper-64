    ...
    <footer className="bg-slate-900 text-slate-300 py-12">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className={withDelay(animationClasses.fadeIn, 100)}>
            <div className="text-xl font-semibold text-white mb-4">MapScraper</div>
            <p className="text-slate-400 mb-4">
              The most powerful and intuitive tool for extracting business data from Google Maps.
            </p>
          ...
          <div className={withDelay(animationClasses.fadeIn, 200)}>
          ...
          <div className={withDelay(animationClasses.fadeIn, 300)}>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-slate-500 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} MapScraper. All rights reserved.
          </div>
