...
export default function Features() {
  ...
  return <section id="features" className="pb-24 bg-slate-50 pt-2">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <div key={feature.title} className={`bg-white rounded-xl p-6 shadow-soft hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 ${withDelay(animationClasses.fadeIn, getDelay(index))}`}>
